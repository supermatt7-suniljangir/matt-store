  ...
  _generateMarkup() {
    ...
    return data
      ...
      <div class="cart-product-l">
        <img src="${el.thumbnail}" alt="${el.title}" class="cart-product-thumbnail">
      </div>
      ...
      <p class="para-large cart-product-price"><b>$${el.price} </b></p>
   
      </div>
      </a>
      <a href="#${el.id}" class="delete-link"><div class="delete-from-cart delete-from-cart-btn" data-id="${el.id}"><svg width="25" height="30" viewBox="0 0 37 42" fill="none" xmlns="http://www.w3.org/2000/svg">
